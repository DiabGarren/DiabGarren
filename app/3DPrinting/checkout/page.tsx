  ...
  return (
    ...
    >
      ...
      <h2 className="my-[15px]">
        ...
        >
          <div className="w-[250px] md:w-[300px] ml-[-35px] md:ml-0 bg-white rounded-lr p-[10px] shadow-xl border-2 border-print-blue">
            <p>
              {'"Custom 3D Printing"'} is a startup. We make use of Pudo locker
              to locker shipping for our deliveries.
            </p>
          </div>
        </Popup>{" "}
        :
      ...
      <div className="flex justify-evenly">
        <div>
          <label htmlFor="collect" className="mr-[5px] cursor-pointer">
            Collect
          </label>
          <input
            type="radio"
        ...
        <div>
          <label htmlFor="deliver" className="mr-[5px] cursor-pointer">
            Deliver
          </label>
          <input
            type="radio"
      ...
      {shipping === "deliver" ? (
        <div
          className={`${shipping === "deliver" ? "block" : "hidden"} my-[15px]`}
        >
          <h2>Shipping cost:</h2>
          <p>R60</p>
      ...
      <button
        ...
        onClick={async () =>
          await fetch(
            process.env.NEXT_PUBLIC_API_URL + "/3DPrinting/checkout",
            {
              method: "POST",
